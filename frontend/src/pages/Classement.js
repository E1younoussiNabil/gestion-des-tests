  ...
  useEffect(() => {
    const fetchClassement = async () => {
      ...
      try {
        ...
        const url = qs.toString() ? `/api/resultats/classement?${qs.toString()}` : '/api/resultats/classement';
        ...
        console.error('Classement fetch error:', e);
    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Classement</h1>
          <p className="text-gray-600">Classement global (score puis temps)</p>
        </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {rows.map((r) => {
                    const isMe = user && r?.candidatId === user.id;
                    const rowKey = [
                      r?.candidatId,
                      r?.modeTest || '',
                      r?.specialite || '',
                    ...
                    return (
                      <tr key={rowKey} className={isMe ? 'bg-blue-50' : ''}>
